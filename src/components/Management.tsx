...
function Management() {
    return (
        <div className='bg-[#F9F9F9] px-6'>
            <div className='bg-[#2C0922] rounded-lg py-4 px-5'>
                <h1 className='text-white text-base font-semibold leading-normal pb-3 text-center'>Management Development Program</h1>
                <Image src="/images/Management.jpg" alt="Management" width={250} height={100} className="rounded-t-lg rounded-bl-lg pb-4 w-full" />
                <p className="text-white text-sm font-normal leading-normal">Tobams Group offers a comprehensive Management
                ...
                <br />
                <p className="text-white text-sm font-normal leading-normal pb-5">Our program includes workshops, seminars, coaching
